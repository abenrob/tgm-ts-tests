 ...
 *
 */
export declare type ReachableTile = {
    [tileId: number]: number;
};
/**
 * The available statistics groups of the statistic service and the vector tiles service
 */
export declare type StatisticsGroupId = number | StatisticsGroups;
export declare enum StatisticsGroups {
 ...
 *
 */
export declare type TravelSpeed = 'slow' | 'medium' | 'fast';
/**
 *
 */
export declare type TravelType = 'walk' | 'car' | 'bike' | 'transit';
export declare class TravelSpeedValues {
    speed?: number;
    uphill?: number;
    downhill?: number;
}
 ...
 *
 */
export declare type EdgeWeightType = 'time' | 'distance';
/**
 * @hidden
 */
 ...
 */
export declare class StatisticValues {
    readonly values: RawStatisticsValues;
    readonly total: number;
    constructor(values: RawStatisticsValues);
}
 ...
 */
export declare type StatisticsList = {
    [statisticKeyId: string]: StatisticValues;
};
