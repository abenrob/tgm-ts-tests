...
export declare class UseCacheRequestOptions {
    useClientCache: boolean;
}
export declare class BaseRequestOptions {
...
export declare class TravelRequestOptions extends BaseRequestOptions {
    /**
